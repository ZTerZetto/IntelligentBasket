...
/**
 * Created by pengchenghu on 2019/1/21.
 * Author Email: 15651851181@163.com
 * Describe: 此demo用于结合SDK实现定位和点聚合
 */
@SuppressLint("ValidFragment")
public class MapViewFragment extends Fragment implements SensorEventListener, BaiduMap.OnMapLoadedCallback {
    ...
    public MyLocationListenner myListener = new MyLocationListenner();  // 位置信息监听
    ...
    public void initWidge(LayoutInflater inflater, ViewGroup container){
        ...
        mClusterManager.setOnClusterClickListener(new ClusterManager.OnClusterClickListener<MyItem>() {
            ...
            public boolean onClusterClick(Cluster<MyItem> cluster) {
                List<MyItem> items = (List<MyItem>) cluster.getItems();  // 获取当前类所有的marker
...
//                                    "获取权限成功，部分权限未正常授予", Toast.LENGTH_SHORT).show();
    ...
    public void addMarkers() {
        ...
        items.add(new MyItem(l1A, bundle1_0));
        items.add(new MyItem(l1B, bundle1_0));
        items.add(new MyItem(l1C, bundle1_0));
        items.add(new MyItem(l1D, bundle1_1));
        items.add(new MyItem(l1E, bundle1_1));
        items.add(new MyItem(l1F, bundle1_2));
        items.add(new MyItem(l1G, bundle1_2));
        items.add(new MyItem(l2A, bundle2_1));
        items.add(new MyItem(l2B, bundle2_2));
        items.add(new MyItem(l3A, bundle3_1));
        items.add(new MyItem(l3B, bundle3_2));
        items.add(new MyItem(l4A, bundle4_1));
        items.add(new MyItem(l4B, bundle4_2));
