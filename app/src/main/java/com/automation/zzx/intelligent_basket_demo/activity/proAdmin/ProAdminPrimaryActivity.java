        ...
        BaseOkHttpClient.newBuilder()
                ...
                .enqueue(new BaseCallBack() {
                    ...
                    public void onError(int code) {
                        ...
                        switch (code){
                            case 401: // 未授权
                                ToastUtil.showToastTips(ProAdminPrimaryActivity.this, "登录已过期，请重新登陆");
                                startActivity(new Intent(ProAdminPrimaryActivity.this, LoginActivity.class));
                                ProAdminPrimaryActivity.this.finish();
                                break;
                            case 403: // 禁止
                                break;
                            case 404: // 404
