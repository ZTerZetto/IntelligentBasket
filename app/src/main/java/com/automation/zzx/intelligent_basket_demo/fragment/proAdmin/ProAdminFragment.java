 ...
 * Describe:项目管理员用户页面
 */
public class ProAdminFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //切换角色
        llSwitch = (LinearLayout) view.findViewById(R.id.switch_layout); //切换角色
        llSwitch.setVisibility(View.VISIBLE);
        rlSwitch =  (RelativeLayout) view.findViewById(R.id.more_item_switch_layout); //切换角色
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            case R.id.login_layout:  // 跳转至个人信息页面
                ...
                //角色更改为项目管理员
                mUserInfo.setUserRole("projectAdmin");
    ...
    private void switchToWorker() {
        startActivity(new Intent(getActivity(), WorkerPrimaryActivity.class));
        getActivity().finish();
    }
