        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (photo_exist.equals(false)) {
                    ...
                    userinfo = new UserInfo(edt_userName.getText().toString(), edt_userPwd.getText().toString(),
                            edt_userPhone.getText().toString(), "rentAdmin",genderType,/*edt_userAge.getText().toString(),*/
                            edt_userLocal.getText().toString(),edt_userIDNum.getText().toString());
                    mLoadingDialog.show();
                    //uploadPhoto();
