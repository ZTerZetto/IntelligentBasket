...
public class ProAdminPrimaryOld1Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pro_admin_primary_old);
        getUserInfo();
        initWidget();

        MiPushUtil.initMiPush(ProAdminPrimaryOld1Activity.this, mUserInfo.getUserId(), null);
    ...
    private void initWidget(){
        ...
        //吊篮管理功能列表点击事件
        mBasAdapter = new FunctionAdapter(ProAdminPrimaryOld1Activity.this,R.layout.item_function,mBasFunctions);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position){
                    case 0:  //配置清单
                        ...
                        intent = new Intent(ProAdminPrimaryOld1Activity.this, ConfigurationActivity.class);
                    ...
                    case 1: //吊篮列表
                        ...
                        intent = new Intent(ProAdminPrimaryOld1Activity.this, BasketStateListActivity.class);
                        intent.putExtra(PROJECT_ID, mProjectInfoList.get(currentSelectedProject).getProjectId());
                        intent.putExtra(PROJECT_NAME, mProjectInfoList.get(currentSelectedProject).getProjectName());
                        startActivity(intent);
                        break;
                    case 2: //平面图
                        intent = new Intent(ProAdminPrimaryOld1Activity.this, BasketStickerActivity.class);
                        startActivity(intent);
                        break;
                    case 3: //报修记录
                        Log.i(TAG, "You have clicked the repair information button");
                        intent = new Intent(ProAdminPrimaryOld1Activity.this, RepairInfoListActivity.class);
                        intent.putExtra(PROJECT_ID, mProjectInfoList.get(currentSelectedProject).getProjectId());
                        intent.putExtra(PROJECT_NAME, mProjectInfoList.get(currentSelectedProject).getProjectName());
                        startActivity(intent);
                        break;
        ...
        mProAdapter = new FunctionAdapter(ProAdminPrimaryOld1Activity.this,R.layout.item_function,mProFunctions);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    case 0: //查看合同
                        ...
                        intent = new Intent(ProAdminPrimaryOld1Activity.this, CheckCompactActivity.class);
                        startActivity(intent);
                        break;
                    case 1: //预验收申请
                        Log.i(TAG, "You have clicked the pre_apply compact button");
                        intent = new Intent(ProAdminPrimaryOld1Activity.this, UploadImageFTPActivity.class);
                        intent.putExtra(PROJECT_ID, mProjectInfoList.get(currentSelectedProject).getProjectId());
                    ...
                    case 3: //预报停申请
                        ...
                        intent = new Intent(ProAdminPrimaryOld1Activity.this, UploadPreStopInfoActivity.class);
                        intent.putExtra(PROJECT_ID, mProjectInfoList.get(currentSelectedProject).getProjectId());
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.entrance_info:  // 点击消息入口
                ...
                intent = new Intent(ProAdminPrimaryOld1Activity.this, ProAdminMessageActivity.class);
                startActivity(intent);
                break;
            case R.id.entrance_mine:  // 点击我的入口
                Log.i(TAG, "You have clicked the select projectList button");
                intent = new Intent(ProAdminPrimaryOld1Activity.this, ProAdminSetActivity.class);
                startActivity(intent);
                break;
        }
    }
        ...
        BaseOkHttpClient.newBuilder()
                ...
                .enqueue(new BaseCallBack() {
                    ...
                    public void onError(int code) {
                        ...
                        switch (code){
                            case 401: // 未授权
                                ToastUtil.showToastTips(ProAdminPrimaryOld1Activity.this, "登录已过期，请重新登陆");
                                startActivity(new Intent(ProAdminPrimaryOld1Activity.this, LoginActivity.class));
                                ProAdminPrimaryOld1Activity.this.finish();
                                break;
                            case 403: // 禁止
                                break;
                            case 404: // 404
