...
public class ProjectFinishedActivity extends AppCompatActivity implements View.OnClickListener{

    private final static String TAG = "ProjectFinishedActivity";
    //handler 消息类型
    ...
    private TextView txtEndTime;  //项目开始时间
    ...
    private RelativeLayout rlInstall; //安装方案
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_project_finished);
        getBaseInfoFromPred();
        getUserInfo();
        initWidget();
        mHandler.sendEmptyMessage(UPDATE_AREA_ADMIN_PROJECT_LIST_MSG);

        MiPushUtil.initMiPush(ProjectFinishedActivity.this, mUserInfo.getUserId(), null);
    }
    ...
    private void initWidget(){
        ...
        txtEndTime  = (TextView) findViewById(R.id.tv_pro_end);
        ...
        //历史记录功能列表点击事件
        mRecordAdapter = new FunctionAdapter(ProjectFinishedActivity.this,R.layout.item_function,mRecordFunctions);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    case 0: //安装记录
                        ...
                        intent = new Intent(ProjectFinishedActivity.this, InstallInfoListActivity.class);
                        intent.putExtra(PROJECT_ID, projectInfo.getProjectId());
                        startActivity(intent);
                        break;
                    case 1: //报警记录
                        Log.i(TAG, "You have clicked the pre_apply compact button");
                        intent = new Intent(ProjectFinishedActivity.this, AlarmRecordProjectActivity.class);
                        intent.putExtra(PROJECT_ID, projectInfo.getProjectId());
                        startActivity(intent);
                        break;
                    case 2: //报修记录
                        Log.i(TAG, "You have clicked the repair information button");
                        intent = new Intent(ProjectFinishedActivity.this, RepairInfoListActivity.class);
                        intent.putExtra(PROJECT_ID, projectInfo.getProjectId());
                    ...
                    case 3: //报停记录
                        ...
                        intent = new Intent(ProjectFinishedActivity.this, StopRecordActivity.class);
                        intent.putExtra(PROJECT_ID, projectInfo.getProjectId());
                        startActivity(intent);
                        break;
                    default:
    ...
    private void initFunctionList(){
        ...
        Function compact = new Function("安装记录", R.mipmap.icon_func_contact,true);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.entrance_info:  // 点击消息入口
                Log.i(TAG, "You have clicked the select projectList button");
                intent = new Intent(ProjectFinishedActivity.this, AreaAdminMessageActivity.class);
                startActivity(intent);
                break;
            case R.id.entrance_mine:  // 点击我的入口
                Log.i(TAG, "You have clicked the select projectList button");
                intent = new Intent(ProjectFinishedActivity.this, AreaAdminSetActivity.class);
                startActivity(intent);
                break;
            case R.id.rl_project_info:  // 项目基本信息
                Log.i(TAG, "You have clicked the select projectList button");
                intent = new Intent(ProjectFinishedActivity.this, ProDetailActivity.class);
        ...
        BaseOkHttpClient.newBuilder()
                ...
                .enqueue(new BaseCallBack() {
                    ...
                    public void onError(int code) {
                        ...
                        switch (code){
                            case 401: // 未授权
                                ToastUtil.showToastTips(ProjectFinishedActivity.this, "登录已过期，请重新登陆");
                                startActivity(new Intent(ProjectFinishedActivity.this, LoginActivity.class));
                                ProjectFinishedActivity.this.finish();
                                break;
                            case 403: // 禁止
                                break;
                            case 404: // 404
    ...
    public void updateProjectContentView(){
        ...
        txtEndTime.setText(projectInfo.getProjectEnd());
        switch(projectInfo.getProjectState()){
            case "1":
            case "0":/* 立项、安装 */
                txtStartTime.setText("暂未开始");
                txtEndTime.setText("暂未结束");
