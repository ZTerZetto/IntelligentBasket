...
public class ProjectInstallActivity extends AppCompatActivity implements View.OnClickListener{

    private final static String TAG = "ProjectInstallActivity";
    //handler 消息类型
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_project_install);
        ...
        MiPushUtil.initMiPush(ProjectInstallActivity.this, mUserInfo.getUserId(), null);
    ...
    private void initWidget(){
        ...
        //历史记录功能列表点击事件
        mRecordAdapter = new FunctionAdapter(ProjectInstallActivity.this,R.layout.item_function,mRecordFunctions);
    ...
    private void initFunctionList(){
        ...
        Function compact = new Function("安装方案", R.mipmap.icon_func_contact,true);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.entrance_info:  // 点击消息入口
                Log.i(TAG, "You have clicked the select projectList button");
                intent = new Intent(ProjectInstallActivity.this, AreaAdminMessageActivity.class);
                startActivity(intent);
                break;
            case R.id.entrance_mine:  // 点击我的入口
                Log.i(TAG, "You have clicked the select projectList button");
                intent = new Intent(ProjectInstallActivity.this, AreaAdminSetActivity.class);
                startActivity(intent);
                break;
            case R.id.rl_project_info:  // 项目基本信息
                Log.i(TAG, "You have clicked the select projectList button");
                intent = new Intent(ProjectInstallActivity.this, ProDetailActivity.class);
                intent.putExtra("projectId", mProjectId);
                startActivity(intent);
                break;
            case R.id.rl_compact_info:  // 查看合同
                Log.i(TAG, "You have clicked the examine compact button");
                intent = new Intent(ProjectInstallActivity.this, CheckCompactActivity.class);
                startActivity(intent);
                break;
        }
    }
        ...
        BaseOkHttpClient.newBuilder()
                ...
                .enqueue(new BaseCallBack() {
                    ...
                    public void onError(int code) {
                        ...
                        switch (code){
                            case 401: // 未授权
                                ToastUtil.showToastTips(ProjectInstallActivity.this, "登录已过期，请重新登陆");
                                startActivity(new Intent(ProjectInstallActivity.this, LoginActivity.class));
                                ProjectInstallActivity.this.finish();
                                break;
                            case 403: // 禁止
                                break;
                            case 404: // 404
