...
public class AreaAdminPrimaryActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    * */
    ...
    private void initWidget(){
        ...
        //吊篮管理功能列表点击事件
        mBasAdapter = new FunctionAdapter(AreaAdminPrimaryActivity.this,R.layout.item_function,mBasFunctions);
        ...
        mProAdapter = new FunctionAdapter(AreaAdminPrimaryActivity.this,R.layout.item_function,mProFunctions);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    ...
                    case 1: //预验收申请
                        ...
                        intent = new Intent(AreaAdminPrimaryActivity.this, UploadImageFTPActivity.class);
                        intent.putExtra(PROJECT_ID, mProjectInfoList.get(currentSelectedProject).getProjectId());
                    ...
                    case 3: //预报停
                        ...
                        intent = new Intent(AreaAdminPrimaryActivity.this, UploadPreStopInfoActivity.class);
                        intent.putExtra(PROJECT_ID, mProjectInfoList.get(currentSelectedProject).getProjectId());
    ...
    private void initFunctionList(){
        ...
        Function preFinish = new Function("预报停", R.mipmap.icon_func_pre_end,true);
